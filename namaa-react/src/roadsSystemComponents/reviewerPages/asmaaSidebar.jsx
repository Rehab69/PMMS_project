...
import asmaa from "./asmaa.png";

//        ******* paths for reviewer *******
//               <Link to="/roadsSystem/reviewer/">
//               <Link to="/roadsSystem/reviewer/">
//               <Link to="/roadsSystem/reviewer/majorroads">
//               <Link to="/roadsSystem/reviewer/majorroads/sections">
//               <Link to="/roadsSystem/reviewer/majorroads/intersections">
//               <Link to="/roadsSystem/reviewer/minorroads">
...
const NewSideBar2 = (props) => {
  ...
  const userName = "Asmaa Abdelmonem";
      ...
      <nav id="sidebar" className="sidebar-wrapper" style={{ width: "17vw" }}>
        <div className="sidebar-content">
          <div className="sidebar-brand">
            <Link to="/RMS/reviewer">Home</Link>
          ...
          <div className="sidebar-header">
            ...
            <div className="user-info">
              <span className="user-role">Reviewer</span>
              ...
              <li className="sidebar-dropdown" ref={majorRef}>
                ...
                <div className="sidebar-submenu" ref={majorSubmenuRef}>
                  <ul>
                    <li>
                      <Link
                        to="/RMS/reviewer/majorroads/sections"
                    ...
                    <li>
                      <Link
                        to="/RMS/reviewer/majorroads/intersections"
                        style={{ paddingRight: "0px" }}
                      >
