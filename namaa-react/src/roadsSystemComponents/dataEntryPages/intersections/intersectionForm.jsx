...
class IntersectionsForm extends Component {
  state = {
    id: this.props.id,
    SampleId: this.props.id,
    intersectionId: this.props.intersectionId,
    route1Id: this.props.route1Id,
    route2Id: this.props.route1Id,
    Survey_No: null,
    Collected_Date: null,
    Survey_Responsible: "",
      ...
      <form onSubmit={this.handleSubmit} style={{ textAlign: "left" }}>
        ...
        <div className="form-row">
          <div className="form-group col-md-4">
            <label> intersection Id: {this.state.intersectionId} </label>
          </div>
          <div className="form-group col-md-4">
            <label>route(1) Id: {this.state.route1Id}</label>
          </div>
          <div className="form-group col-md-4">
            <label>route(2) Id: {this.state.route2Id}</label>
          </div>
        </div>
...
export default IntersectionsForm;
