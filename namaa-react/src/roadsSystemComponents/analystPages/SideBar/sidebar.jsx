...
const regionSubmenuRef = useRef()
  return (
    <Fragment>
        ...
        <nav id="sidebar" className="sidebar-wrapper" style={{width:'38vh'}}>
          <div className="sidebar-content">
            <div className="sidebar-brand">

              <Link to="/RMS/Analyst">Home</Link>
...
<i className="fa fa-road"/>
                  ...
                  <div className="sidebar-submenu" ref={majorSubmenuRef}>
                    <ul>
                      <li>
                        <Link to="/RMS/Analyst/majorroads"  style={{paddingRight:"0px"}}>
                          Surveyed Major Roads
                         
                        </Link>
                      </li>
                      <li>
                        <Link to="/RMS/Analyst/MRcondition" style={{paddingRight:'0px'}}>
                           Pavement Condition
                          </Link>
                      </li>
                ...
                <li className="sidebar-dropdown" ref={regionRef}>
                  ...
                  <div className="sidebar-submenu" ref={regionSubmenuRef}>
                    <ul>
                      <li>
                        <Link to="/RMS/Analyst/regions" style={{paddingRight:'0px'}}>  Surveyed Regions </Link>
                      </li>
                      <li>
                        <Link to="/RMS/Analyst/REGcondition" style={{paddingRight:'0px'}}>
                         Pavement Condition
                          </Link>
                      </li>
