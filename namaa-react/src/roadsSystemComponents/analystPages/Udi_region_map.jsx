...
export const Udi_region_map = (props) =>{
      ...
      () => {
        ...
        .then(([Map, MapView, FeatureLayer, Search, Compass, Home, Viewpoint, BasemapToggle,Legend, Expand]) => {
          ...
          const layer = new FeatureLayer({
            // URL to the service
            url: "https://services.arcgis.com/Lob4uxfVT5t0AXMF/arcgis/rest/services/MadinatyRoads/FeatureServer/5"
          });
