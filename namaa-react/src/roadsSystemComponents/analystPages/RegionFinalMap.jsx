      ...
      () => {
        ...
        .then(([Map, MapView, BasemapGallery , AreaMeasurement2D , FeatureLayer]) => {
          ...
          const layer = new FeatureLayer({
            // URL to the service
            url: "https://services.arcgis.com/Lob4uxfVT5t0AXMF/arcgis/rest/services/MadinatyRoads/FeatureServer/6"
          });
